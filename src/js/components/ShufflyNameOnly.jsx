...
class ShufflyLandingPage extends React.Component {
	...
	onChange = () => {
		...
		case 'signup-failed-existing-account':
			updateState.phone_existing_error = true;

		case 'signup-failed':
			updateState.error = true;

			// Focus on phone inputbox
			this.refs.phone.select();

			this.setState(updateState);
			break;
		case 'normal':
			updateState.name_success = true;
            updateState.phone_success = true;
	...
	signUp = () => {
		...
		if (status == 'signup-failed-existing-account') {
			state.error = true;
			state.phone_existing_error = true;
		}
		...
		// Sign up now
		this.flux.dispatch('action.User.signUpNameOnly',
			name,
            phone
		);
	}
	...
	render() {
        ...
        if (this.state.phone_empty_error) {
			message = (
				<div className="ui negative message">
					<i className="close icon" onClick={this.closeAlert}></i>
					<div className="header">Oops !!</div>
		...
		if (this.state.phone_existing_error) {
			message = (
				<div className="ui negative message">
					<i className="close icon" onClick={this.closeAlert}></i>
					<div className="header">Oops !!</div>
					<p>這個電話已經有人用囉! 請重新輸入。</p>
				</div>
			);
		}
		if (this.state.name_success || this.state.phone_success) {
			message = (
			...
			<div className='shuffly-page'>
                ...
                <div className="ui one column centered grid" style={topSection}>
                    <div className="column">
                        ...
                        <h2 style={fontStyle}>一趟顛覆傳統的旅程<br />開啓人生無限的可能</h2>
                    </div>
                </div>
                ...
                <div className="ui one column stackable centered grid">
                    <div className="four wide column">
                        ...
                        <h1>隨機地點</h1>
                        <h3 style={fontStyle}>當您確認可旅行的天數，我們將會替您從全球 100 個以上的旅遊地點，隨機選出最合適您的目的地。而無論是哪，全都是我們精心規劃的旅程、都絕對值得您去期待。</h3>
                    </div>
                </div>
                <div className="ui one column stackable centered grid">
                    <div className="four wide column">
                ...
                <div className="ui one column stackable centered grid">
                    <div className="four wide column">
                        ...
                        <h1>24 小時全天候支援</h1>
                        <h3 style={fontStyle}>我們的專員提供全天無休的支援服務，從遊覽建議、交通導航、文化簡介，一直到安全事項與緊急救援等，讓您像個身經百戰的旅遊達人，可以盡興探索又安全無虞。</h3>
                        <div className='ui hidden divider'></div>
                        <div className='ui hidden divider'></div>
                    </div>
                </div>
                ...
                <div className="ui one column stackable centered grid" style={graySectionStyle} ref='app_section'>
                    <div className="four wide column">
                        ...
                        <img className="ui centered small image" src={logo} alt=""/>
                        <h2>即將推出</h2>
                        <h3 style={fontStyle}>立即登記，以確保正式上線時第一時間獲得通知！</h3>
                        <div className='ui hidden divider'></div>
                        <div className="ui form">
                            <div className="field">
                                <input type="text" ref="name" placeholder="姓名" onChange={this.closeAlert} />
                            </div>
                            <div className="field">
                                <input type="text" ref="phone" placeholder="電話" onChange={this.closeAlert} />
                            </div>
                            <div className={'large ui youtube button ' + signupBtnClass} onClick={this.signUp}>
        						訂閱通知
        					</div>
                        </div>
                        {message}
                ...
                <div className="ui one column stackable centered grid" style={deepGraySectionStyle}>
                    <div className="four wide column">
                        ...
                        <ol className="ui list" style={listStyle}>
                            <li>您隨機抽出的旅遊地點，皆為免簽證與落地簽證國家，以確保您可在 24 小時內合法入境至國家，而您必須確認您的護照俱有半年以上有效期限。</li>
                            <li>當您確認參加旅程後，將會預先收到隨機選出的國家景點之消費成本估算、交通、景點、風俗習慣、法律與其他注意事項等資訊，以利於您做行程前的準備參考。</li>
                            <li>若因時間不足而無法解決外幣兌換、機場接送交通等問題，我們可額外提供相關服務，以確保您的行程無礙。</li>
                            <li>我們將提供每位旅客全程網際網路，以確保每位旅客可以便於查詢資訊並隨時與我們的旅行達人維持聯繫。</li>
                            <li>我們的專員為即時線上咨詢服務，若依狀況遭遇任何緊急或意外事故，則有在地特約專員提供當地服務。</li>
                        </ol>
                        <div className='ui hidden divider'></div>
                        <div className='ui hidden divider'></div>
                        <div className="ui section divider"></div>
